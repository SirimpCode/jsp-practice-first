	...
	<div class="row my-3 text-left">
	        ...
	        <div class="flip-card">
	           <div class="flip-card-inner">			
				  <div class="flip-card-front">
	                  <img src="${product.productImage1}" class="img-fluid" style="width: 100%;" />
	              </div>
	              <div class="flip-card-back">
	                  <img src="${product.productImage2}" class="img-fluid" style="width: 100%;" />
	              </div>
	          </div>
	        </div>    
	    </div>
	    ...
	    <div class="col-md-6 pl-5">
	        <ul class="list-unstyled">
	            <li><span style="color: red; font-size: 12pt; font-weight: bold;">${product.productSpec.productSpecName}</span></li>
	            <li>제품번호: ${product.productId}</li>
				<li>제품이름: ${product.productName}</li>
